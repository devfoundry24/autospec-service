...
import com.wm.domain.service.ProductEnrichmentService;
...
public class BeanConfig {
    ...
    @Bean
    public ProductEnrichmentUseCase productTypeClassificationUseCase(
            ProductFeedItemRepositoryPort repositoryPort,
            LLMClientPort llmClientPort
    ) {
        return new ProductEnrichmentService(repositoryPort, llmClientPort);
    }
